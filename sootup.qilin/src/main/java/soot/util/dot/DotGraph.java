 ...
 * <ol>
 *   <li>new DotGraph
 *   <li>draw(Directed/Undirected)Edge, attachAttributes, addNode
 *   <li>plot
 * </ol>
 */
public class DotGraph extends AbstractDotGraphElement implements Renderable {
   ...
   *
   * <p>NOTE: Alias for {@link #setAttribute(java.lang.String, java.lang.String)}.
   *
   ...
   * sets any general attributes
   *
   * <p>NOTE: Alias for {@link #setAttribute(soot.util.dot.DotGraphAttribute)}.
   *
   ...
   * creates a sub graph.
   *
   * <p>NOTE: Some renderers require subgraph labels to start with "cluster".
   *
