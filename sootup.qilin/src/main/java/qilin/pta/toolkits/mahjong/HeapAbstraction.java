...
/**
 * @author Tian Tan
 * @author Yue Li refactered by Dongjie He.
 */
public class HeapAbstraction {
  ...
  /** This map would be manipulated by multiple threads thus it should be concurrent hashmap. */
  ...
  /**
   * During equivalence check, each thread holds a DFAMap which contains the DFA of the objects of
   * the type. After comparison, the DFAMap and its containing DFA will be released to save memory
   * space.
   */
