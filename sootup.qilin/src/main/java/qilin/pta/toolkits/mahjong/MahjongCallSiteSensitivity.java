...
public final class MahjongCallSiteSensitivity extends ContextSensitivity {
  private final int k;
  private final int hk;

  public MahjongCallSiteSensitivity(int k, int hk) {
  ...
  public BasePTA createPTA(PTAScene scene, PointerAnalysisConfig config) {
    return new MahjongPTA(scene, k, hk, createContextConstructor());
  }

  @Override
  public String toString() {
    return label("mahjong", k, "c", hk);
  }
}
