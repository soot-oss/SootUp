...
public class OCG {
  ...
  /**
   * (1) case1: objects on OCG have successors but does not have predecessors. (1-1) factorys (1-2)
   * normal uses. (2) case2: objects on OCG does not have successors. (2-1) no predecessors. (2-2)
   * have predecessors. (3) othercase: objects on OCG have successors and predecessors.
   */
  public void stat() {
    int case1 = 0;
    int total_factory = 0;
  ...
  /**
   * patterns in case1: (1) create one object and never return out of the method. (2) create one
   * object and then return out (factory).
   */
