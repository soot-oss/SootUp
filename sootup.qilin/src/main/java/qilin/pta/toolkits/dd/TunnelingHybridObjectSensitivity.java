...
public final class TunnelingHybridObjectSensitivity extends ContextSensitivity {
  private final int k;
  private final int hk;

  public TunnelingHybridObjectSensitivity(int k, int hk) {
  ...
  public String toString() {
    return label("tunneling", k, "hybobj", hk);
  }
}
