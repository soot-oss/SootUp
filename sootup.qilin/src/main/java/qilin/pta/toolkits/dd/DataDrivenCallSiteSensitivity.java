...
/** Data-driven 2-callsite-sensitivity. Only k=2/hk=1 is supported by {@link DataDrivenPTA}. */
public final class DataDrivenCallSiteSensitivity extends ContextSensitivity {

  public DataDrivenCallSiteSensitivity() {}
  ...
  public BasePTA createPTA(PTAScene scene, PointerAnalysisConfig config) {
    return new DataDrivenPTA(scene, createCtxConstructor());
  }

  @Override
  public String toString() {
    return label("datadriven", 2, "c", 1);
  }
}
