...
public class ConcurrentTwoKeyMultiMap<K1, K2, V> {
  private final ConcurrentHashMap<K1, SetMultimap<K2, V>> map = new ConcurrentHashMap<>();

  public boolean put(K1 key1, K2 key2, V value) {
    return map.computeIfAbsent(
            key1,
            k -> Multimaps.newSetMultimap(new ConcurrentHashMap<>(), ConcurrentHashMap::newKeySet))
        .put(key2, value);
  }
