...
public class Main {
  public static void main(String[] args) {
    ...
    PropertyGraphComparer comparer = new PropertyGraphComparer(joernOutputDirectory, sootUpOutputDirectory);
    System.out.println(comparer.getNumberOfDifferentMethods());
