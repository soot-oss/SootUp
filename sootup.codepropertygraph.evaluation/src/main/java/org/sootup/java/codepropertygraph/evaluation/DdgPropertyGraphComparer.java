...
public class DdgPropertyGraphComparer {
  private final JoernDdgGenerator joernDdgGenerator;
  private final SootUpDdgGenerator sootUpDdgGenerator;
  private final JoernDdgAdapter joernDdgAdapter;
  private final SootUpDdgAdapter sootUpDdgAdapter;
  private int totalSameEdges;
  private int totalDiffEdges;
  private int totalMethods;

  public DdgPropertyGraphComparer(
      JoernDdgGenerator joernDdgGenerator, SootUpDdgGenerator sootUpDdgGenerator) {
    this.joernDdgGenerator = joernDdgGenerator;
    this.sootUpDdgGenerator = sootUpDdgGenerator;
    this.joernDdgAdapter = new JoernDdgAdapter(joernDdgGenerator);
    this.sootUpDdgAdapter = new SootUpDdgAdapter(sootUpDdgGenerator);
  }

  public boolean compareDdg(Graph joernDdg, PropertyGraph sootUpDdg, String methodFullName) {

    PropertyGraph joernPropertyGraph = joernDdgAdapter.getDdg(joernDdg);
    PropertyGraph sootUpPropertyGraph = sootUpDdgAdapter.getDdg(sootUpDdg);
