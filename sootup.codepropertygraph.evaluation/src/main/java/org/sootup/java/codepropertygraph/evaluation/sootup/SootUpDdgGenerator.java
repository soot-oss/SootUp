...
public class SootUpDdgGenerator {
  private final Map<String, SootMethod> methods = new HashMap<>();

  public SootUpDdgGenerator(Path sourceCodeDirPath) {
  ...
  public PropertyGraph getDdg(SootMethod method) {
    return DdgCreator.convert(new MethodInfo(method));
  }
