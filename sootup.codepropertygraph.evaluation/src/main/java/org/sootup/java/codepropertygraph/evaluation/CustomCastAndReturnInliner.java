 ...
 */
public class CustomCastAndReturnInliner implements BodyInterceptor {
  ...
  public void interceptBody(@Nonnull Body.BodyBuilder builder, @Nonnull View view) {
    ...
    for (Stmt stmt : Lists.newArrayList(originalGraph.getNodes())) {
      ...
      if (originalGraph.successors(gotoStmt).isEmpty()) continue;
      ...
      if (originalGraph.successors(assign).isEmpty()) continue;
