...
public class JimpleVisitorTest {
  ...
  public void testValueVisitorConstant() {
    JimpleParser parser =
        JimpleConverterUtil.createJimpleParser(CharStreams.fromString("15"), Paths.get(""));
    ...
    parser =
        JimpleConverterUtil.createJimpleParser(CharStreams.fromString("\"test\""), Paths.get(""));
  ...
  public void testValueVisitorImmediate() {
    JimpleParser parser =
        JimpleConverterUtil.createJimpleParser(CharStreams.fromString("r0"), Paths.get(""));
  ...
  public void testStmtVisitorAssignment() {
    ...
    // "r0 = 15;"
    JimpleParser parser =
        JimpleConverterUtil.createJimpleParser(CharStreams.fromString("r0 = 15;"), Paths.get(""));
  ...
  public void testStmtVisitorGoto() {
    // "goto L1;"
    JimpleParser parser =
        JimpleConverterUtil.createJimpleParser(CharStreams.fromString("goto L1;"), Paths.get(""));
    Stmt s = stmtVisitor.visitStatement(parser.statement());
