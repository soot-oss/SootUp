...
public class ValidateFieldsInClass {
  ...
  public void test() {
    ...
    FieldSignature fieldSign =
        new FieldSignature(mainClassSignature, "fieldSubClass", PrimitiveType.getInt());
    ...
    FieldSignature fieldsignSuper =
        new FieldSignature(mainClassSignature, "fieldSuper", PrimitiveType.getInt());
    ...
    FieldSignature fieldSignRandom =
        new FieldSignature(mainClassSignature, "fieldRandom", PrimitiveType.getInt());
