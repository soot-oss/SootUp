...
public class ModuleMultiReleaseJarAnalysisInputLocationTest extends AnalysisInputLocationTest {
    ...
    public void modularMultiReleaseJar() {
        ...
        ModuleInfoAnalysisInputLocation moduleMultiReleaseJarAnalysisInputLocation8 =
                new ModuleMultiReleaseJarAnalysisInputLocation(mmrj, SourceType.Application, new JavaLanguage(8));

        final JavaView view_8 =
                new JavaModuleView(Collections.emptyList(), Collections.singletonList(moduleMultiReleaseJarAnalysisInputLocation8));

        ModuleMultiReleaseJarAnalysisInputLocation moduleMultiReleaseJarAnalysisInputLocation9 =
                new ModuleMultiReleaseJarAnalysisInputLocation(mmrj, SourceType.Application, new JavaLanguage(9));
        ...
        // TODO: test what happens if we put a *non* ModuleClassType into a ModuleMultiReleaseAnalysisInoutLocation
