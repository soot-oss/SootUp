...
public class BytecodeHierarchyTest {
    ...
    public void setUp() {
        ...
        JavaClassPathAnalysisInputLocation analysisInputLocation = new JavaClassPathAnalysisInputLocation(jarFile);
        view = new JavaView(Arrays.asList(new DefaultRTJarAnalysisInputLocation(), analysisInputLocation));
