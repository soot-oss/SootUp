 ...
 * that are independent of each other. This is necessary as the AsmMethodSource maps usages of the same Local index to the same Local object,
 * which can lead to wrong Jimple e.g. when a primitive type gets merged with a reference-type and augmenting the type of the Local is less precise.
 *
