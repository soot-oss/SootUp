...
public class ClassHierarchyAnalysisAlgorithmTest extends CallGraphAlgorithmTest {
  ...
  //    CallGraph cg = loadCallGraph("bachelor.fix.RunFinalizer");
  ...
  //    CallGraph cg = loadCallGraph("bachelor.intra.reflection.ReflectiveInvokeExample");
  //    MethodSignature calleeMethodSig =
  //        identifierFactory.getMethodSignature(
  ...
  //    CallGraph cg = loadCallGraph("bachelor.intra.reflection.ReflectiveInvokeExample3");
  ...
  //    CallGraph cg = loadCallGraph("bachelor.intra.reflection.ReflectiveInvokeExample4");
  //    MethodSignature calleeMethodSig =
  //        identifierFactory.getMethodSignature(
  //
  ...
  //    CallGraph cg = loadCallGraph("bachelor.intra.reflection.ReflectiveInvokeExample6");
  //    MethodSignature calleeMethodSig =
  //        identifierFactory.getMethodSignature(
  //
  ...
  //    CallGraph cg = loadCallGraph("bachelor.intra.reflection.ReflectiveInvokeExample8");
  ...
  //    CallGraph cg = loadCallGraph("bachelor.intra.reflection.ReflectiveInvokeExample9");
