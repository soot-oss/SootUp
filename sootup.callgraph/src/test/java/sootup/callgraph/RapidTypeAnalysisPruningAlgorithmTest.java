...
public class RapidTypeAnalysisPruningAlgorithmTest
    extends CallGraphTestBase<RapidTypeAnalysisPruningAlgorithm> {
   ...
   * graph, because the algorithm overrides the <code>includeCall</code> method and excludes <code>
   * methodB</code>.
   */
  @Test
