...
public class PerformanceTest {
  ...
  class PolymorphicCallsPerformance {
    ...
    JavaClassType classType =
        view.getIdentifierFactory().getClassType("sootup.callgraph.performance.PolymorphicCalls");
    MethodSignature entryMethodSig =
        view.getIdentifierFactory()
            .getMethodSignature(
                classType, "main", VoidType.getInstance(), Collections.singletonList(classType));

    @Test
    public void testPolymorphicCallsCHA() {
      CallGraph cgCHA1 =
          new ClassHierarchyAnalysisAlgorithm(view)
              .initialize(Collections.singletonList(entryMethodSig));
    }
  ...
  class InvokeFromClassItselfPerformance {
    ...
    // entry method
    JavaClassType classType2 =
        view2
            .getIdentifierFactory()
            .getClassType("sootup.callgraph.performance.InvokeFromClassItself");
    MethodSignature entryMethodSig2 =
        view2
            .getIdentifierFactory()
            .getMethodSignature(
                classType2, "main", VoidType.getInstance(), Collections.singletonList(classType2));

    @Test
    public void testInvokeFromClassItselfCHA() {
      CallGraph cgCHA2 =
          new ClassHierarchyAnalysisAlgorithm(view2)
              .initialize(Collections.singletonList(entryMethodSig2));
    }

    @Test
    public void testInvokeFromClassItselfRTA() {
      CallGraph cgRTA2 =
          new RapidTypeAnalysisAlgorithm(view2)
              .initialize(Collections.singletonList(entryMethodSig2));
    }
  ...
  class InvokeDefaultMethodPerformance {
    ...
    // entry method
    JavaClassType classType3 =
        view3
            .getIdentifierFactory()
            .getClassType("sootup.callgraph.performance.InvokeDefaultMethodExample");
    MethodSignature entryMethodSig3 =
        view3
            .getIdentifierFactory()
            .getMethodSignature(
                classType3, "main", VoidType.getInstance(), Collections.singletonList(classType3));

    @Test
    public void testInvokeDefaultMethodCHA() {
      CallGraph cgCHA3 =
          new ClassHierarchyAnalysisAlgorithm(view3)
              .initialize(Collections.singletonList(entryMethodSig3));
    }

    @Test
    public void testInvokeDefaultMethodRTA() {
      CallGraph cgRTA3 =
          new RapidTypeAnalysisAlgorithm(view3)
              .initialize(Collections.singletonList(entryMethodSig3));
    }
  }
}
