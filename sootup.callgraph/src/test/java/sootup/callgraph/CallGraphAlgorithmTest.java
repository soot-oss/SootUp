...
// Fix calls tests
    ...
    public void testRunFinalizer() {
      ...
      MethodSignature calleeMethodSig = identifierFactory.getMethodSignature(identifierFactory.getClassType("java.lang.ref.Finalizer"), "runFinalization", "void", Collections.emptyList());
...
// Intra Calls tests
  ...
  public void testReflectiveInvokeExample() {
    ...
    MethodSignature calleeMethodSig = identifierFactory.getMethodSignature(identifierFactory.getClassType("bachelor.intra.reflection.ReflectiveInvokeExample$Target"), "targetMethod", "void", Collections.emptyList());
    Set<MethodSignature> calleeSourcesMethodSig = cg.callSourcesTo(calleeMethodSig);
    assertTrue(calleeSourcesMethodSig.contains(mainMethodSignature));
  }
  ...
  public void testReflectiveInvokeExample3() {
    ...
    MethodSignature calleeMethodSigA = identifierFactory.getMethodSignature(identifierFactory.getClassType("bachelor.intra.reflection.ReflectiveInvokeExample3$T"), "a", "void", Collections.emptyList());
    MethodSignature calleeMethodSigB = identifierFactory.getMethodSignature(identifierFactory.getClassType("bachelor.intra.reflection.ReflectiveInvokeExample3$T"), "b", "void", Collections.emptyList());
  ...
  public void testReflectiveInvokeExample4() {
    ...
    MethodSignature calleeMethodSig = identifierFactory.getMethodSignature(identifierFactory.getClassType("bachelor.intra.reflection.ReflectiveInvokeExample4$T"), "helloWorld", "void", Collections.emptyList());
    Set<MethodSignature> calleeSourcesMethodSig = cg.callSourcesTo(calleeMethodSig);
    assertTrue(calleeSourcesMethodSig.contains(mainMethodSignature));
  }
  ...
  public void testReflectiveInvokeExample6() {
    ...
    MethodSignature calleeMethodSig = identifierFactory.getMethodSignature(identifierFactory.getClassType("bachelor.intra.reflection.ReflectiveInvokeExample6$T"), "x", "void", Collections.emptyList());
    Set<MethodSignature> calleeSourcesMethodSig = cg.callSourcesTo(calleeMethodSig);
    assertTrue(calleeSourcesMethodSig.contains(mainMethodSignature));
  }
  ...
  public void testReflectiveInvokeExample8() {
    ...
    MethodSignature calleeMethodSigTarget = identifierFactory.getMethodSignature(identifierFactory.getClassType("bachelor.intra.reflection.ReflectiveInvokeExample8$Target"), "target", "void", Collections.emptyList());
    MethodSignature calleeMethodSigOther = identifierFactory.getMethodSignature(identifierFactory.getClassType("bachelor.intra.reflection.ReflectiveInvokeExample8$Target"), "other", "void", Collections.emptyList());
  ...
  public void testReflectiveInvokeExample9() {
    ...
    MethodSignature calleeMethodSig1 = identifierFactory.getMethodSignature(identifierFactory.getClassType("bachelor.intra.reflection.ReflectiveInvokeExample9$Base"), "targetMethod", "void", Collections.emptyList());
    MethodSignature calleeMethodSig2 = identifierFactory.getMethodSignature(identifierFactory.getClassType("bachelor.intra.reflection.ReflectiveInvokeExample9$Base"), "targetMethod", "void", Collections.singletonList("java.lang.String"));
...
//    }
  ...
  //        identifierFactory.getMethodSignature(
  //            identifierFactory.getClassType("cvc.Class"), "target", "void",
  // Collections.emptyList());
  //    assertTrue(
  //        cg.containsCall(
  //            mainMethodSignature,
  ...
  //    MethodSignature targetMethod =
  //        identifierFactory.getMethodSignature(
  //            identifierFactory.getClassType("ccp.Class"), "method", "int",
  // Collections.emptyList());
  //    assertTrue(
  //        cg.containsCall(sourceMethod, targetMethod, getInvokableStmt(sourceMethod,
  // targetMethod)));
  //  }
  //
  //  @Test
  ...
  //    assertTrue(
  //        cg.containsCall(
  //            mainMethodSignature, firstMethod, getInvokableStmt(mainMethodSignature,
  // firstMethod)));
  //
  //    MethodSignature targetMethod =
  //        identifierFactory.getMethodSignature(
  ...
  //            Collections.emptyList());
  //    assertTrue(
  //        cg.containsCall(firstMethod, targetMethod, getInvokableStmt(firstMethod,
  // invokedMethod)));
  //  }
  //
  //  @Test
  ...
  //    MethodSignature firstMethod =
  //        identifierFactory.getMethodSignature(
  //            identifierFactory.getClassType("nvc5.Sub"), "method", "void",
  // Collections.emptyList());
  //    assertTrue(
  //        cg.containsCall(
  //            mainMethodSignature, firstMethod, getInvokableStmt(mainMethodSignature,
  ...
  //    assertTrue(
  //        cg.containsCall(
  //            mainMethodSignature, callMethod, getInvokableStmt(mainMethodSignature,
  // callMethod)));
  //
  //    MethodSignature targetMethod =
  //        identifierFactory.getMethodSignature(
  ...
  //    MethodSignature callMethod =
  //        identifierFactory.getMethodSignature(
  //            identifierFactory.getClassType("vc4.Class"), "method", "void",
  // Collections.emptyList());
  ...
  //    assertTrue(
  //        cg.containsCall(
  //            mainMethodSignature, compute, getInvokableStmt(mainMethodSignature,
  // invokedCompute)));
  //  }
  //
  //  @Test
  ...
  //    assertTrue(
  //        cg.containsCall(
  //            combinedInterfaceMethod, method, getInvokableStmt(combinedInterfaceMethod,
  // method)));
  //
  ...
  //    MethodSignature method =
  //        identifierFactory.getMethodSignature(
  //            identifierFactory.getClassType("am1.Class"), "method", "void",
  // Collections.emptyList());
  //
  ...
  //    assertTrue(
  //        cg.containsCall(
  //            mainMethodSignature, method, getInvokableStmt(mainMethodSignature,
  // abstractMethod)));
  //    assertFalse(
  //        cg.containsCall(
  //            mainMethodSignature,
  ...
  //    MethodSignature method =
  //        identifierFactory.getMethodSignature(
  //            identifierFactory.getClassType("am2.Class"), "method", "void",
  // Collections.emptyList());
  //
  //    MethodSignature abstractMethod =
  //        identifierFactory.getMethodSignature(
  ...
  //    MethodSignature method =
  //        identifierFactory.getMethodSignature(
  //            identifierFactory.getClassType("am3.Class"), "method", "void",
  // Collections.emptyList());
  //
  //    MethodSignature superMethod =
  //        identifierFactory.getMethodSignature(
  ...
  //    JavaView view =
  // createViewForClassPath("src/test/resources/callgraph/DefaultEntryPoint/binary");
  //
  //    JavaClassType mainClassSignature = identifierFactory.getClassType("example2.Example");
  //    MethodSignature mainMethodSignature =
  //        identifierFactory.getMethodSignature(
  //            mainClassSignature, "main", "void",
  // Collections.singletonList("java.lang.String[]"));
  //
  //    CallGraphAlgorithm algorithm = createAlgorithm(view);
  //    CallGraph cg = algorithm.initialize();
  //    assertTrue(
  //        cg.containsMethod(mainMethodSignature), mainMethodSignature + " is not found in
  // CallGraph");
  //    assertNotNull(cg);
  //  }
  //
  //  /**
  //   * Test uses initialize() method to create call graph, but multiple main methods are present
  // in
  ...
  //
  //  /**
  //   * Test uses initialize() method to create call graph, but no main method is present in input
  // java
  ...
  //    } catch (RuntimeException e) {
  //      assertEquals(
  //          "No main method is present in the input programs. initialize() method can be used if
  // only one main method exists in the input program and that should be used as entry point for
  ...
  //    inputLocations.add(
  //        new JavaClassPathAnalysisInputLocation(classPath + "application/",
  ...
  //        identifierFactory.getMethodSignature(
  //            identifierFactory.getClassType("issue903.A"), "close", "void",
  // Collections.emptyList());
  //    MethodSignature closingCallInvoked =
  //        identifierFactory.getMethodSignature(
  //            identifierFactory.getClassType("issue903.B"), "close", "void",
  // Collections.emptyList());
  //
  //    assertTrue(
  //        cg.containsCall(
  ...
  //
  //    assertTrue(
  //        cg.containsCall(closingCall, closingCall, getInvokableStmt(closingCall, closingCall,
  // 0)));
  //  }
  //
  //  @Test
  ...
  //        identifierFactory.getMethodSignature(
  //            identifierFactory.getClassType("t6.NoThread"), "run", "void",
  // Collections.emptyList());
