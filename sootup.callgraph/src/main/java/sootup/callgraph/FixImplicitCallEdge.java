...
/**
 * For implicit method calls that do not require any type of resolution, the edge between the
 * <code>sourceMethod</code> and the <code>callee</code> can be directly established!
 */
