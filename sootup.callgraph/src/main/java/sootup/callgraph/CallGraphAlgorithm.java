...
public interface CallGraphAlgorithm {
  ...
  //   * TODO: Question: A usecase could be we already constructed a CG for a smaller part of a
  // program. Now, we want to construct a CG over the whole program. Use the already constructed CG
  // as base. We would need extra information (--> entryPoints) to construct the rest.
  //   *
  //   * @param callGraph a call graph to  of entry points for the call graph algorithm. The
  // algorithm starts at
  //   *     these methods and inspects all reachable methods.
