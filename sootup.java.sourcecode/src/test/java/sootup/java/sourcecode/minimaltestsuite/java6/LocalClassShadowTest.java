...
public class LocalClassShadowTest extends MinimalSourceTestSuiteBase {
  ...
  public void testOuterClass() {
    assertEquals(
        ...
        loadClass(testedClassName + "1$LocalClass").getOuterClass().get());
  }
  ...
  public void testNumOfLocalsWithString() {
    SootMethod method =
        loadClass(testedClassName + "1$LocalClass")
            .getMethod(getMethodSignature().getSubSignature())
            .get();
  ...
  public MethodSignature getMethodSignature() {
    return identifierFactory.getMethodSignature(
        identifierFactory.getClassType(testedClassName + "1$LocalClass"),
        "printInfo",
        "void",
