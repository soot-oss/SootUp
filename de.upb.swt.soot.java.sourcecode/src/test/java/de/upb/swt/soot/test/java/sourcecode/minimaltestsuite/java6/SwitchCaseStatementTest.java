...
public class SwitchCaseStatementTest extends MinimalTestSuiteBase {
  ...
  //            "$r2 = \"\"",
  //            "$r3 = staticinvoke <SwitchCaseStatement$Color: SwitchCaseStatement$Color
  // valueOf(java.lang.String)>($r1)",
  //            "$r4 = <SwitchCaseStatement$Color: SwitchCaseStatement$Color RED>",
  //            "if $r3 == $r4 goto $r6 = <SwitchCaseStatement$Color: SwitchCaseStatement$Color
  // RED>",
  //            "$r5 = <SwitchCaseStatement$Color: SwitchCaseStatement$Color GREEN>",
  //            "if $r3 == $r5 goto $r7 = <SwitchCaseStatement$Color: SwitchCaseStatement$Color
  // GREEN>",
