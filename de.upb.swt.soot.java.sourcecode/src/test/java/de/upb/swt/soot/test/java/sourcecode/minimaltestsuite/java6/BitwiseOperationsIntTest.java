...
public class BitwiseOperationsIntTest extends MinimalTestSuiteBase {
  ...
  public void defaultTest() {
    ...
    loadMethod(
        expectedBodyStmts("r0 := @this: BitwiseOperationsInt","$i0 = 70","$i1 = 20","$i2 = $i0 & $i1","return"),
    ...
    loadMethod(
        expectedBodyStmts("r0 := @this: BitwiseOperationsInt","$i0 = 70","$i1 = neg $i0","return"),
        getMethodSignature("bitwiseOpComplement"));

    loadMethod(
        expectedBodyStmts("r0 := @this: BitwiseOperationsInt","$i0 = 70","$i1 = $i0 >> 5","return"),
