...
public class ExceptionalBlockGraph extends BlockGraph implements ExceptionalGraph<Block> {
  ...
  public ExceptionalBlockGraph(Body body) {
    this(new soot.toolkits.graph.ExceptionalUnitGraph(body));
  }
  ...
  protected Map<Unit, Block> buildBlocks(Set<Unit> leaders, UnitGraph uncastUnitGraph) {
    soot.toolkits.graph.ExceptionalUnitGraph unitGraph = (soot.toolkits.graph.ExceptionalUnitGraph) uncastUnitGraph;
  ...
  private Map<Block, Collection<ExceptionDest>> buildExceptionDests(soot.toolkits.graph.ExceptionalUnitGraph unitGraph,
  ...
  /**
   * Utility method which, given a {@link Block} and the {@link soot.toolkits.graph.ExceptionalUnitGraph} from which it was constructed, returns
   ...
   *
   * @param unitGraph
   *          the {@link soot.toolkits.graph.ExceptionalUnitGraph} from which this graph is constructed.
   *
   * @param unitToBlock
   ...
   */
  private Collection<ExceptionDest> collectDests(Block block, soot.toolkits.graph.ExceptionalUnitGraph unitGraph, Map<Unit, Block> unitToBlock) {
    ...
    for (Unit unit : block) {
      Collection<soot.toolkits.graph.ExceptionalUnitGraph.ExceptionDest> unitDests = unitGraph.getExceptionDests(unit);
  ...
  public static class ExceptionDest implements soot.toolkits.graph.ExceptionalGraph.ExceptionDest<Block> {
