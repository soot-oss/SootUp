 ...
 * </p>
 */
public class ExceptionalUnitGraph extends UnitGraph implements soot.toolkits.graph.ExceptionalGraph<Unit> {
   ...
   *          A <code>Map</code> from {@link Unit}s to {@link Collection}s of {@link ExceptionDest
  ...
  /**
   * Returns a collection of {@link ExceptionDest ExceptionDest} objects which represent how exceptions
  ...
  public static class ExceptionDest implements soot.toolkits.graph.ExceptionalGraph.ExceptionDest<Unit> {
    private Trap trap;
    private ThrowableSet throwables;
