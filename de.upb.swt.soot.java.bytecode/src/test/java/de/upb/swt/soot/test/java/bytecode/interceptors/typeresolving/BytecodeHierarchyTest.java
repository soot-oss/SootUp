...
public class BytecodeHierarchyTest {
    ...
    private ClassType rootInterface1, rootInterface2, subInterface1, class1, class2, class3, class4, double_class, int_class, object, serializable, cloneable, number, comparable;
    ...
    private ArrayType objArr, seriArr, doubleArr, class1Arr, class2Arr, class2AArr, class3Arr, class4Arr, doubleArr_prim, intArr_prim;
