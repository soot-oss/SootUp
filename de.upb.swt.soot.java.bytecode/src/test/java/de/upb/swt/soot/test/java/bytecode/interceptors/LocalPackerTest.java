...
public class LocalPackerTest {
    ...
    Stmt stmt3 = JavaJimple.newAssignStmt(l2hash4, DoubleConstant.getInstance(2.0), noStmtPositionInfo);
    Stmt stmt4 = JavaJimple.newAssignStmt(l1hash5, JavaJimple.newAddExpr(l1hash3, IntConstant.getInstance(1)), noStmtPositionInfo);
    Stmt stmt5 = JavaJimple.newAssignStmt(l1hash5, JavaJimple.newAddExpr(l1hash5, IntConstant.getInstance(1)), noStmtPositionInfo);
    ...
    private Body createBody(){
        ...
        MethodSignature methodSignature = new MethodSignature(classType, "test", parameters, VoidType.getInstance());
        builder.setMethodSignature(methodSignature);

        // build set locals
        Set<Local> locals = ImmutableUtils.immutableSet(l0, l1, l2, l3, l1hash1, l2hash2, l1hash3, l2hash4, l1hash5);
