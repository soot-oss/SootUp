...
public class NopEliminatorTest {
    ...
    /**
     * Tests the correct handling of a nop statement at the end of the stmtList.
    ...
    /**
     * Verifies that two Lists of {@link Stmt} are the same, using appropriate assertions.
     * @param expected The expected List
     * @param actual The transformed List
     */
