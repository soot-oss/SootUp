...
public class LocalSplitterTest {
  ...
  public void testLocalSplitterForMultilocals() {
    /**
     * Body body = createMultilocalsBody(); LocalSplitter localSplitter = new LocalSplitter(); Body
     * newBody = localSplitter.interceptBody(body); Body expectedBody =
     * createExpectedMuiltilocalsBody();
     *
     * <p>// check newBody's locals assertLocalsEquiv(expectedBody.getLocals(),
     * newBody.getLocals());
     *
     * <p>// check newBody's first stmt
     * assertTrue(expectedBody.getFirstStmt().equivTo(newBody.getFirstStmt()));
     *
     * <p>// check newBody's stmtGraph assertStmtGraphEquiv(expectedBody.getStmtGraph(),
     * newBody.getStmtGraph());
     */
  }
  ...
  public void testLocalSplitterForBinaryBranches() {
    /**
     * Body body = createBBBody(); LocalSplitter localSplitter = new LocalSplitter(); Body newBody =
     * localSplitter.interceptBody(body); Body expectedBody1 = createExpectedBBBody1(); Body
     * expectedBody2 = createExpectedBBBody2();
     *
     * <p>// check newBody's locals assertLocalsEquiv(expectedBody1.getLocals(),
     * newBody.getLocals());
     *
     * <p>// check newBody's first stmt
     * assertTrue(expectedBody1.getFirstStmt().equivTo(newBody.getFirstStmt()));
     *
     * <p>// check newBody's stmtGraph assertStmtGraphEquiv(expectedBody1.getStmtGraph(),
     * expectedBody2.getStmtGraph(), newBody.getStmtGraph());
     */
  }
  ...
  public void testLocalSplitterForLoop() {
    /**
     * Body body = createLoopBody(); LocalSplitter localSplitter = new LocalSplitter(); Body newBody
     * = localSplitter.interceptBody(body); Body expectedBody = createExpectedLoopBody();
     */
