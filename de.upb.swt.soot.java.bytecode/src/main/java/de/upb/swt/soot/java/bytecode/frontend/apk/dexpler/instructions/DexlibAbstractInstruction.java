...
import de.upb.swt.soot.java.bytecode.frontend.apk.tag.BytecodeOffsetTag;
import de.upb.swt.soot.java.bytecode.frontend.apk.tag.Host;
import de.upb.swt.soot.java.bytecode.frontend.apk.tag.LineNumberTag;
import de.upb.swt.soot.java.bytecode.frontend.apk.tag.SourceLineNumberTag;
...
public abstract class DexlibAbstractInstruction {
  ...
  /**
   * Set the Jimple Stmt, that comprises this instruction.
   *
   * Does not override already set stmts.
   */
  protected void setStmt(Stmt s) {
    stmt = s;
  }
