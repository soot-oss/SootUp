...
public class Register implements Cloneable {
  ...
  public static final Register EMPTY_REGISTER = new Register(new PrimitiveType.IntType(), 0);
  ...
  public boolean isFloat() {
    return type instanceof PrimitiveType.FloatType;
  }

  public boolean isDouble() {
    return type instanceof PrimitiveType.DoubleType;
  }
