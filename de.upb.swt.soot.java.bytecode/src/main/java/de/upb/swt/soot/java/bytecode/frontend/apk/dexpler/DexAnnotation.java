  ...
  private Type getSootType(AnnotationElem e) {
    ...
    switch (e.getKind()) {
      ...
      case 'e': // enum
        ...
        annotationType = soot.dexpler.Util.getType(enumElem.getTypeName());
        ;
        break;
      ...
      case 'V':
      case 'Z':
        annotationType = soot.dexpler.Util.getType(String.valueOf(e.getKind()));
        break;
      default:
        annotationType = null;
        break;
    ...
    switch (atypes) {
      ...
      case DALVIK_ANNOTATION_ENCLOSINGCLASS:
        ...
        for (AnnotationElement elem : a.getElements()) {
          ...
          outerClass = soot.dexpler.Util.dottedClassName(outerClass);
      ...
      case DALVIK_ANNOTATION_INNERCLASS:
        ...
        if (clazz.hasOuterClass()) {
          ...
          if (soot.dexpler.Util.isByteCodeClassName(classType)) {
            outerClass += ";";
          }
        } else if (classType.contains("$")) {
        ...
        if (outerClass != null && !clazz.hasOuterClass()) {
          String sootOuterClass = soot.dexpler.Util.dottedClassName(outerClass);
