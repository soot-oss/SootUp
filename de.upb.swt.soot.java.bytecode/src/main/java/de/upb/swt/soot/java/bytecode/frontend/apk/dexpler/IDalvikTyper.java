...
public interface IDalvikTyper {
  ...
  public abstract void setType(Value v, Type type, boolean isUse);

  // public abstract void setObjectType(ValueBox v);
  public abstract void addConstraint(Value box1, Value box2);

  // public abstract void addStrongConstraint(ValueBox vb, Type t);
  abstract void assignType(Body.BodyBuilder b);
