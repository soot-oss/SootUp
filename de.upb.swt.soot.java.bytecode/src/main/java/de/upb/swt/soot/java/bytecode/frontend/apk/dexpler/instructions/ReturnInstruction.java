...
public class ReturnInstruction extends DexlibAbstractInstruction {
  ...
  public void jimplify(DexBody body) {
    ...
    JReturnStmt returnStmt = Jimple.newReturnStmt(l, StmtPositionInfo.createNoStmtPositionInfo());
    setStmt(returnStmt);
    addTags(returnStmt);
    body.add(returnStmt);
    ...
    if (IDalvikTyper.ENABLE_DVKTYPER) {
      ...
      DalvikTyper.v().setType(returnStmt.getOpBox(), body.getBody().getMethodSignature().getType(), true);
    }
  }
}
