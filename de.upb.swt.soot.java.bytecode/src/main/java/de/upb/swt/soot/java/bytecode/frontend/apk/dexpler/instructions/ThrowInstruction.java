...
public class ThrowInstruction extends DexlibAbstractInstruction {
  ...
  public void jimplify(DexBody body) {
    ...
    JThrowStmt throwStmt = Jimple.newThrowStmt(body.getRegisterLocal(throwInstruction.getRegisterA()), StmtPositionInfo.createNoStmtPositionInfo());
    setStmt(throwStmt);
    addTags(throwStmt);
    body.add(throwStmt);

    if (IDalvikTyper.ENABLE_DVKTYPER) {
      DalvikTyper.v().setType(throwStmt.getOpBox(), new JavaClassType("java.lang.Throwable"), true);
    }
  }
}
