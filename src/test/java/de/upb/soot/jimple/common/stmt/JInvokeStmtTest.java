...
public class JInvokeStmtTest {
  ...
  public void test() {
    ...
    IStmt staticInvokeStmt
            = new JInvokeStmt(new JStaticInvokeExpr(view, statMethodRef, Arrays.asList(StringConstant.getInstance("Towel"))), nop);
    ...
    IStmt specialInvokeStmt = new JInvokeStmt(new JSpecialInvokeExpr(view,
            new Local("$r0", new RefType(view, sootClass.getSignature())), smethodRef, Arrays.asList()), nop);
    ...
    IStmt interfaceInvokeStmt = new JInvokeStmt(new JInterfaceInvokeExpr(view,
            new Local("r2", new RefType(view, sootClass.getSignature())), imethodRef, Arrays.asList()), nop);
    ...
    IStmt dynamicInvokeStmt
            = new JInvokeStmt(new JDynamicInvokeExpr(view, bootstrapMethodRef, bootstrapArgs, dmethodRef, methodArgs), nop);
