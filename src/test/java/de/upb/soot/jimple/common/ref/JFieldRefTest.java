...
public class JFieldRefTest {
	...
	public void testJStaticFieldRef() {
		...
		SootField field = new SootField(view, declaringClassSignature, fieldSig, fact.getTypeSignature("int"),
		...
		SootClass mainClass = new SootClass(view, ResolvingLevel.BODIES,
				...
				ClassType.Application, null, Collections.emptySet(), null, Collections.singleton(field), Collections.emptySet(), null,
	...
	public void testJInstanceFieldRef() {
		...
		SootClass mainClass = new SootClass(view, ResolvingLevel.BODIES,
				new JavaClassSource(new JavaSourcePathNamespace(""), null, declaringClassSignature),
				ClassType.Application,null, Collections.emptySet(), null,
				Collections.singleton(field), Collections.emptySet(), null, EnumSet.of(Modifier.PUBLIC));
