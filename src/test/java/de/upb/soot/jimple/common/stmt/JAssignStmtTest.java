...
public class JAssignStmtTest {
    ...
    public void test(){
        ...
        Assert.assertTrue(deepStmt.equivTo(new JAssignStmt(new Local("$i0", IntType.getInstance() ) ,  new JAddExpr(numConst1, numConst2) )));
        ...
        Assert.assertFalse(lStmt.equivTo(new JAssignStmt(new Local("$i100differentname", IntType.getInstance() ) , IntConstant.getInstance(42))));
        Assert.assertFalse(lStmt.equivTo(new JAssignStmt(new Local("$i0", LongType.getInstance() ) , LongConstant.getInstance(42))));
