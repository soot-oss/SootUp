...
public class ModuleCompositionTest {
  ...
  public void apiExamples() {
    ...
    JavaClassType utilsClassSignature = p.getSignatureFactory().getClassType("de.upb.soot.Utils");
    ...
    JavaClassType classSignature = view.getSignatureFactory().getClassType("x.y.z.foo.Bar");
