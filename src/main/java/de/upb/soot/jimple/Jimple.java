...
public class Jimple {
	...
	public static List<String> jimpleKeywordList() {
		...
		Collections.addAll(l, NEWARRAY, NEWMULTIARRAY, NOP, RET, SPECIALINVOKE, STATICINVOKE, TABLESWITCH,
				VIRTUALINVOKE, NULL_TYPE, UNKNOWN, CMP, CMPG, CMPL, ENTERMONITOR, EXITMONITOR, INTERFACEINVOKE,
				LENGTHOF, LOOKUPSWITCH, NEG, IF, ABSTRACT, BOOLEAN, BREAK, BYTE, CASE, CATCH, CHAR, CLASS, FINAL,
				NATIVE, PUBLIC, PROTECTED, PRIVATE, STATIC, SYNCHRONIZED, TRANSIENT, VOLATILE, STRICTFP, ENUM,
				ANNOTATION, INTERFACE, VOID, SHORT, INT, LONG, FLOAT, DOUBLE, EXTENDS, IMPLEMENTS, BREAKPOINT, DEFAULT,
				GOTO, INSTANCEOF, NEW, RETURN, THROW, THROWS, NULL, FROM, TO, WITH, CLS, TRUE, FALSE);
		return l;
	}
	...
	/**
	 * Constructs a NewSpecialInvokeExpr(Local base, SootMethod method, List of
	...
	/**
	 * Constructs a NewDynamicInvokeExpr(SootMethod bootstrapMethodRef, List
	 * bootstrapArgs, SootMethod methodRef, List args) grammar chunk.
	 */
	...
	/**
	 * Constructs a NewVirtualInvokeExpr(Local base, SootMethod method, List of
	 * Immediate) grammar chunk.
	 */
	...
	/**
	 * Constructs a NewInterfaceInvokeExpr(Local base, SootMethod method, List of
	 * Immediate) grammar chunk.
	 */
	...
	/**
	 * Constructs a TableSwitchStmt(Immediate, int, int, List of Unit, Stmt) grammar
	 * chunk.
	 */
	public static JTableSwitchStmt newTableSwitchStmt(Value key, int lowIndex, int highIndex,
