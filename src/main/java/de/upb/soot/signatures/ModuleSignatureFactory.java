...
public class ModuleSignatureFactory extends DefaultSignatureFactory {
  ...
  /**
   * Returns a unique ModuleSignature. The methodRef looks up a cache if it already contains a signature with the given module
   * name. If the cache lookup fails a new signature is created. Returns a unique ModuleSignature. The methodRef looks up a
  ...
  /**
   * Returns a unique PackageSignature. The methodRef looks up a cache if it already contains a signature with the given package
