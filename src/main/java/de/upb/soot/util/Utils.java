...
public class Utils {
   ...
   */
  @Nonnull
  public static <T> Lazy<T> synchronizedLazy(@Nullable Object mutex, @Nonnull Supplier<T> initializer) {
  ...
  @SafeVarargs
  @Nonnull
  public static <E> ImmutableList<E> immutableList(E e1, E e2, E e3, E e4, E e5, E e6, E e7, E e8, E e9, E e10, E e11, E e12, @Nonnull E... others) {
  ...
  @SafeVarargs
  @Nonnull
  public static <E extends Enum<E>> ImmutableSet<E> immutableEnumSet(@Nonnull E anElement, @Nonnull E... otherElements) {
  ...
  public static final class Functional {
    ...
    /**
     * Gets a {@link Function} that tries to cast an object to the specified class in one step.
     * Use this method in combination with {@link Optional#flatMap(Function)}.
     * <p>
     * <b>Note:</b> It is not recommended to apply this method on {@link Stream streams}.
     * For streams, you may use {@link #filterAllCasted(Stream, Class) filterAllCasted(…)}.
     * 
     * <h2>Example</h2>
     * 
     ...
     * 
     * If you want to apply this try-cast method to a stream, you would have to filter out the
     * empty optionals and to unbox the values, as shown in the following example code.
     * 
     * <pre><code>
     ...
     * use the {@link #filterAllCasted(Stream, Class) filterAllCasted(…)} helper method or to use the
     * conventional way when dealing with streams:
     * 
     * <pre><code>
     * Stream&lt;Foo&gt; mayContainFoos =
     *     collection.stream()
