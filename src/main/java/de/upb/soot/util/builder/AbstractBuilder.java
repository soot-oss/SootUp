...
public abstract class AbstractBuilder<T> {
    ...
    @Nonnull
    private final Class<T> _buildableClass;
    ...
    /**
     * Ensures that a value has been set. Use this method for values that must not be 
     * <code>null</code>.
     * <p>
     * Example:
     * 
     ...
     * @return The value.
     * @throws BuilderException The specified value is <code>null</code> that means,
     ...
     * @throws BuilderException A build error occurred. See the {@link Exception#getCause() cause}
     * to get details about the original exception.
     */
    @Nonnull
    public T build() {
      try {
