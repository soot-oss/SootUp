...
public class JavaModulePathNamespace extends AbstractNamespace {
  ...
  private class SignatureFactoryWrapper implements SignatureFactory {
    ...
    @Override
    public @Nonnull
    JavaClassType getClassType(@Nonnull String fullyQualifiedClassName) {
    ...
    public MethodSignature getMethodSignature(
        @Nonnull String methodName,
        @Nonnull JavaClassType declaringClassSignature,
        @Nonnull String fqReturnType,
        @Nonnull List<String> parameters) {
      return factory.getMethodSignature(
    ...
    public MethodSubSignature getMethodSubSignature(
      ...
      return this.factory.getMethodSubSignature(name, parameterSignatures, returnType);
    }
    ...
    @Override
    public @Nonnull
    JavaClassType fromPath(@Nonnull Path file) {
    ...
    public FieldSubSignature getFieldSubSignature(@Nonnull String name, @Nonnull Type type) {
      return this.factory.getFieldSubSignature(name, type);
    }
