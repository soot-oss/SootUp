...
public abstract class AbstractNamespace implements INamespace {
  protected final de.upb.soot.namespaces.classprovider.ClassProvider classProvider;

  public AbstractNamespace(de.upb.soot.namespaces.classprovider.ClassProvider classProvider) {
