...
public class AugEvalFunctionTest extends TypeAssignerTestSuite {
  ...
  public void testImmediate() {
    ...
    ControlFlowGraph<?> graph2 = builder2.getStmtGraph();
  ...
  public void testAddExpr() {
    ...
    ControlFlowGraph<?> graph5 = builder5.getStmtGraph();
    ...
    ControlFlowGraph<?> graph6 = builder6.getStmtGraph();
    ...
    ControlFlowGraph<?> graph7 = builder7.getStmtGraph();
    ...
    ControlFlowGraph<?> graph8 = builder8.getStmtGraph();
  ...
  public void testRef() {
    ...
    ControlFlowGraph<?> graph3 = builder3.getStmtGraph();
