...
public class RapidTypeAnalysisAlgorithm extends AbstractCallGraphAlgorithm {
  ...
  public RapidTypeAnalysisAlgorithm(@Nonnull View view, @Nonnull TypeHierarchy hierarchy) {
    this.view = view;
  ...
  public CallGraph initialize(@Nonnull List<MethodSignature> entryPoints) {
    ClassHierarchyAnalysisAlgorithm cha = new ClassHierarchyAnalysisAlgorithm(view, hierarchy);
