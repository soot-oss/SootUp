...
public class ViewTypeHierarchyTest {
  ...
  public void implementedInterfacesOf() {
    ...
    //    assertTrue("ArrayList implements Collection", typeHierarchy.isSubtype(collection,
    // arrayList));
  ...
  public void superClassOf() {
    ...
    //    assertEquals(factory.getClassType("de.upb.soot.namespaces.AbstractNamespace"),
    // superClass);
    //    assertNull(
  ...
  public void nullTypeSubtyping() {
    ...
    //        typeHierarchy.isSubtype(factory.getClassType("java.lang.Object"),
    // NullType.getInstance()));
    //    assertTrue(
    //        "null should be valid value for all reference types",
    //        typeHierarchy.isSubtype(factory.getClassType("java.lang.String"),
    // NullType.getInstance()));
    //    assertTrue(
    //        "null should be valid value for all reference types",
