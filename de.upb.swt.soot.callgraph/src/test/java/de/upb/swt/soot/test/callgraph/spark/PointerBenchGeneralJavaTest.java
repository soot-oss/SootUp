...
public class PointerBenchGeneralJavaTest {
    ...
    public void testInterface1() {
        ...
        SootMethod targetMethod = getTargetMethod(targetMethodSig);
        Map<Integer, Local> lineNumberToA = getLineNumberToLocalMap(targetMethod, "benchmark.objects.A", new ArrayList<>());
        Map<Integer, Local> lineNumberToG = getLineNumberToLocalMap(targetMethod, "benchmark.objects.G", new ArrayList<>());
        Map<Integer, Local> lineNumberToH = getLineNumberToLocalMap(targetMethod, "benchmark.objects.H", new ArrayList<>());
    ...
    public void testSuperClasses1() {
        ...
        SootMethod targetMethod = getTargetMethod(targetMethodSig);
        Map<Integer, Local> lineNumberToA = getLineNumberToLocalMap(targetMethod, "benchmark.objects.A", new ArrayList<>());
        Map<Integer, Local> lineNumberToP = getLineNumberToLocalMap(targetMethod, "benchmark.objects.P", new ArrayList<>());
    ...
    public void testOuterClasses1() {
        ...
        SootMethod targetMethod = getTargetMethod(targetMethodSig);
        Map<Integer, Local> lineNumberToA = getLineNumberToLocalMap(targetMethod, "benchmark.objects.A", new ArrayList<>());
        Map<Integer, Local> lineNumberToInnerClass = getLineNumberToLocalMap(targetMethod, "generalJava.OuterClass1$InnerClass", new ArrayList<>());
