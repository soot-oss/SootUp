...
public class SourceLocator {
  ...
  /**
   * Return the class index that maps class names to dex/assembly(exe/dll) files. A dex/exe/dll file
   * contains multiple classes and is not structured as a "folder structure"
   *
   * @return the index
   */
