...
public class DexBody {
    ...
    public String toString() {
        return "The method " + method.getName() + " contains " + numRegisters + " Registers " + "and " + numParameterRegisters + " parameterRegisters." + "\n Is this method Static? " + isStatic + "\n The parameters of this methods are " + parameterNames;
    }
    ...
    public void jimplify(){
        ...
        if(!isStatic){
            ...
            JIdentityStmt idStmt = Jimple.newIdentityStmt(thisLocal, Jimple.newThisRef(classType), StmtPositionInfo.createNoStmtPositionInfo());
            add(idStmt);
        ...
        }
        {
            ...
            for(Type type : parameterTypes) {
                ...
                JIdentityStmt jIdentityStmt = Jimple.newIdentityStmt(gen, Jimple.newParameterRef(type, i++), StmtPositionInfo.createNoStmtPositionInfo());
                add(jIdentityStmt);
                paramLocals.add(gen);
...
//                    classPaths.add("/Users/palaniappanmuthuraman/Desktop/dex_files"); // directory of the current apk we are dealing with
                ClassPathResolver resolver = new ClassPathResolver(classPaths,Collections.emptyList(),dexEntry);
