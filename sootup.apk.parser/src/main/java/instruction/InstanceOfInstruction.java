...
public class InstanceOfInstruction extends DexLibAbstractInstruction {
    ...
    public void jimplify(DexBody body) {
        ...
        JInstanceOfExpr jInstanceOfExpr = Jimple.newInstanceOfExpr(body.getRegisterLocal(source), sootType);
        JAssignStmt jAssignStmt = Jimple.newAssignStmt(body.getRegisterLocal(dest), jInstanceOfExpr, StmtPositionInfo.createNoStmtPositionInfo());
        setStmt(jAssignStmt);
