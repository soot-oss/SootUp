...
public class ConstStringInstruction extends DexLibAbstractInstruction {
    ...
    public void jimplify(DexBody body) {
        ...
        StringConstant stringConstant = new StringConstant(s, JavaIdentifierFactory.getInstance().getType("java.lang.String"));
        JAssignStmt jAssignStmt = Jimple.newAssignStmt(body.getRegisterLocal(dest), stringConstant, StmtPositionInfo.createNoStmtPositionInfo());
        setStmt(jAssignStmt);
