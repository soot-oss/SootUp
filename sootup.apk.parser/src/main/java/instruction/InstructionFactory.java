...
public class InstructionFactory {
    ...
    private static DexLibAbstractInstruction fromOpcode(Opcode opcode, Instruction instruction, int codeAddress) {
        ...
        switch (opcode) {
            ...
            default:
                throw new IllegalArgumentException("Opcode: " + opcode + " @ 0x" + Integer.toHexString(codeAddress));
        }
    }
}
