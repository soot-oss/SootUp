...
public class LocalGeneratorTest extends TestCase {
  ...
  public void testGenerateFieldCollisionHandling() {
    ...
    final Local i1 = localGenerator2.generateField(PrimitiveType.IntType.getInstance());
  ...
  public void testGenerateLocalCollisionHandling() {
    ...
    final Local i2 = localGenerator2.generateField(PrimitiveType.IntType.getInstance());
    ...
    // "old" Localgenerator
    assertEquals(
        "i4", localGenerator.generateField(PrimitiveType.IntType.getInstance()).toString());
