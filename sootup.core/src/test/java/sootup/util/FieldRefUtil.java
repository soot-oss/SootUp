...
public class FieldRefUtil {
  ...
  /**creates a dummy static field reference
   * Signature: dummy Field Signature
   *
  ...
  /**creates a dummy instance field reference
   * local: dummy local
   * Signature: dummy Field Signature
   *
  ...
  public static JInstanceFieldRef createDummyInstanceFieldRef(){
    return new JInstanceFieldRef(LocalUtil.createDummyLocalForInt(), SignatureUtil.createDummyFieldSignature());
  }
