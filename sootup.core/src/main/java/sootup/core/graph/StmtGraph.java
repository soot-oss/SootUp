...
public abstract class StmtGraph<V extends BasicBlock<V>> implements Iterable<Stmt> {
    ...
    public class BlockGraphIteratorAndTrapAggregator extends BlockGraphIterator {
        ...
        /**
         * for jimple serialization - this info contains only valid/useful information if all stmts are iterated i.e. hasNext() == false!
         *
        ...
        public List<Trap> getTraps() {
            ...
            if(!trapStarts.isEmpty()){
                throw new IllegalArgumentException("Invalid StmtGraph. A Trap is not created. Maybe a Traprange covers the last Stmt as well, which is not possible.");
            }
