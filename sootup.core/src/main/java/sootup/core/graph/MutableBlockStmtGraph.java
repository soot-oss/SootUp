...
public class MutableBlockStmtGraph extends MutableStmtGraph {
    ...
    */
    ...
    private MutableBasicBlock splitAndExcludeStmtFromBlock(
        ...
        if (stmtIdx == 0) {
            ...
            block
                    ...
                    .forEach(
                            excludedFromOrigBlock::linkExceptionalSuccessorBlock);
     ...
     */
    protected Pair<Integer, MutableBasicBlock> addNodeToBlock(@Nonnull MutableBasicBlock block, @Nonnull Stmt stmt) {
    ...
    public void replaceNode(@Nonnull Stmt oldStmt, @Nonnull Stmt newStmt) {
        ...
        if (!oldStmt.branches() && !newStmt.branches()) {
            ...
            // update index
            stmtToBlock.put(newStmt, new MutablePair<>(blockOfOldStmt.getStmtCount()-1, blockOfOldStmt));
            int idx = 0;
    ...
    public void insertBefore(
        ...
        if (block.getHead() == beforeStmt) {
            ...
            final MutableBasicBlock successorBlock = block.splitBlockLinked(beforeStmtBlockPair.getLeft());
            ...
            if (tryMergeBlocks(block, successorBlock)) {
                ...
                int idx = 1+block.getStmtCount()-successorBlock.getStmtCount();
