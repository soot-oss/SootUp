...
public class WalaIRToJimpleConverter {
   ...
   * */
  public static de.upb.sse.sootup.core.model.Position convertPosition(
      Position instructionPosition) {
    return new de.upb.sse.sootup.core.model.Position(
  ...
  public static StmtPositionInfo convertPositionInfo(
    ...
    de.upb.sse.sootup.core.model.Position[] operandPos =
        Arrays.stream(operandPosition)
            .map(
                instrPos ->
                    instrPos == null
                        ? null
                        : new de.upb.sse.sootup.core.model.Position(
                            instrPos.getFirstLine(),
                            instrPos.getFirstCol(),
                            instrPos.getLastLine(),
                            instrPos.getLastCol()))
            .toArray(de.upb.sse.sootup.core.model.Position[]::new);
