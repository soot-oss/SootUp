 ...
 */
public class MemorySavingImmutableStmtGraph extends StmtGraph {
  ...
  private MemorySavingImmutableStmtGraph(StmtGraph originalStmtGraph) {
    ...
    for (Stmt node : nodes) {
      ...
      switch (pred.size()) {
        ...
        case 1:
          ...
          break;
        default:
          predecessors[idx] = new ArrayList<>(pred);
      }
      ...
      switch (succ.size()) {
        ...
        case 1:
          ...
          break;
        default:
          successors[idx] = new ArrayList<>(succ);
      }
      idx++;
    }
  }

  public static MemorySavingImmutableStmtGraph copyOf(StmtGraph stmtGraph) {
    if (stmtGraph instanceof MemorySavingImmutableStmtGraph) {
      return (MemorySavingImmutableStmtGraph) stmtGraph;
    }
    return new MemorySavingImmutableStmtGraph(stmtGraph);
  }
  ...
  public List<Stmt> predecessors(@Nonnull Stmt node) {
    ...
    return Collections.unmodifiableList((List<Stmt>) predecessors[idx]);
  }
  ...
  public List<Stmt> successors(@Nonnull Stmt node) {
    ...
    return Collections.unmodifiableList((List<Stmt>) successors[idx]);
  }
