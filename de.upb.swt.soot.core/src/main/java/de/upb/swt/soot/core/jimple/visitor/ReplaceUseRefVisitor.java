...
public class ReplaceUseRefVisitor extends AbstractRefVisitor{
    ...
    @Nonnull
    @Override
    public void caseParameterRef(@Nonnull JParameterRef v){defaultCase(v);}

    @Nonnull
    @Override
    public void caseCaughtExceptionRef(@Nonnull JCaughtExceptionRef v){defaultCase(v);}

    @Nonnull
    @Override
    public void caseThisRef(@Nonnull JThisRef v){defaultCase(v);}
