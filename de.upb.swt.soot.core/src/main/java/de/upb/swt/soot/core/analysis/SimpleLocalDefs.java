...
public class SimpleLocalDefs implements LocalDefs {
    ...
    private static class FlowAssignment extends ForwardFlowAnalysis<FlowAssignment.FlowBitSet> implements LocalDefs {
        ...
        FlowAssignment(StmtGraph graph, Local[] locals, List<Stmt>[] stmtList, int numStmts, boolean omitSSA) {
            super(graph);
