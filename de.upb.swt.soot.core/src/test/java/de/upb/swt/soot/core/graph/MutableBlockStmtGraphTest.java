...
public class MutableBlockStmtGraphTest {
    ...
    private ClassType throwableSig = new ClassType() {
        @Override
  ...
  Stmt firstHandlerStmt = new JIdentityStmt<>(new Local("ex", throwableSig), new JCaughtExceptionRef(throwableSig) , StmtPositionInfo.createNoStmtPositionInfo());
